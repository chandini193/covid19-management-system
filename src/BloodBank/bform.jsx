...
class bform extends Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        axois.post("http://localhost:5000/BloodBank", this.state).then(alert("msg stored"))
            .then(response => {
                console.log(response.data)
            })
    }
    render() {
        const { bloodBankName, email, phoneNumber, address, city, district_name, state_name, remarks } = this.state
        return (
            <div className="App">
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="information">
                        ...
                        <label><FiUser />BloodBank:
                            <input type="text" name="bloodBankName" value={bloodBankName} onChange={this.handleChange} /></label><br />
                        ...
                        <label><BiCurrentLocation />District{" "}:{" "}
                            <input type="text" name="district_name" value={district_name} onChange={this.handleChange} /></label><br />
